 ...
 */
final class Version20181218143202 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad CHANGE start_ad_date start_ad_date DATETIME NOT NULL, CHANGE end_ad_date end_ad_date DATETIME NOT NULL');
    }
}
